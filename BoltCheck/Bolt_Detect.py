...
core = ov.Core()
# 테스트시 경로 수정 필요
model = core.read_model("/home/test/Haidi/team-haidi-project/BoltCheck/model/Bolt/model.xml")
...
try:
    while True:
        ...
        # 볼트 개수 표시
        cv2.putText(frame, f"Bolts: {BoltsCount}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
        if BoltsCount >= 2:
